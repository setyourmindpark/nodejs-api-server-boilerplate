...
describe('SAMPLE_V3', () => {
    describe('GET /api/smpl/select1/param1', () => {
        it('should return sample api', done => {
            request(app)
                .get('/api/smpl/select1/value1')
    ...
    describe('GET /api/smpl/select2/param1/param2', () => {
        it('should return sample api', done => {
            request(app)
                .get('/api/smpl/select2/valu1/value2')
                .set('token', token)    // header setting
                .expect(200)
                .expect("Content-Type", /json/)
                .end((err, res) => {
    ...
    describe('POST /api/smpl/insert', () => {
        it('should return sample api', done => {
            request(app)
                .post('/api/smpl/insert')
                .set('token', token)
                .send({
                  "param1": "value1",
                  "param2": "value2",
    ...
    describe('PUT /api/smpl/update', () => {
        it('should return sample api', done => {
            request(app)
                .put('/api/smpl/update/a')
                .set('token', token)
                .send({
                  "param1": "string",
                  "param2": "value2",
    ...
    describe('DELETE /api/smpl/remove', () => {
        it('should return sample api', done => {
            request(app)
                .delete('/api/smpl/remove/1')
                .set('token', token)
                .send({
                  "param1": "value1",
                  "param2": "value2",
